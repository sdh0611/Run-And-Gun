...
public class PlayerChest : MonoBehaviour {
    ...
    void Get()
    {
        ...
        var Atk = GameObject.FindObjectOfType<PlayerAttack>();  // 스크립트 PlayerAttack.cs의 변수 attacking를 받아오기 위한 var 변수 선언                   
        ...
        anim.SetBool("Attack", Atk.attacking);        // Chest의 Animator Component의 Parameter인 Attack의 값을 잡아준다.
